...
class Help():
    def __init__(self):
        big_font = pygame.font.SysFont('centurygothic', 36)
        self.small_font = pygame.font.SysFont('centurygothic', 22) # этот шрифт надо помнить и для постоянной надписи
        text1 = big_font.render(" Управление: ", 1, C_WHITE)
        text2 = self.small_font.render(" Влево: 'a' или стрелка влево ", 1, C_GREEN)
        text3 = self.small_font.render(" Вправо: 'd' или стрелка влево ", 1, C_YELLOW)
        text4 = self.small_font.render(" Прыжок: 'w' или стрелка верх ", 1, C_GREEN)
        text5 = self.small_font.render(" Выстрел: пробел ", 1, C_YELLOW)
        text6 = self.small_font.render(" Музыка вкл/выкл: 'm', громче: 'u', тише: ' j ' ", 1, C_GREEN)
